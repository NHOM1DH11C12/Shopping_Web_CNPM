...
defined('TEMPLATE_FRONT_USER')?null:define('TEMPLATE_FRONT_USER',__DIR__.DS.'ktemplates\frontend_user');
defined('TEMPLATE_BACK')?null:define('TEMPLATE_BACK',__DIR__.DS.'ktemplates\backend');
defined('TEMPLATE_BACK_USER')?null:define('TEMPLATE_BACK_USER',__DIR__.DS.'ktemplates\backend_user');
...
defined("DB_NAME")?null:define("DB_NAME","toy");
